...
![Minecraft Version](https://img.shields.io/badge/Minecraft-1.21.1/1.21.3/1.21.4/1.21.5/1.21.6/1.21.7%20(2.0.x)-2E7D32?style=for-the-badge&logo=minecraft&logoColor=white)
...
> The Beacon perimeter overlay is part of **mod version 2.0.x** and is currently available for **Minecraft 1.21.1**, **1.21.3**, **1.21.4**, **1.21.5**, **1.21.6** and **1.21.7**.
...
| ---------------- | ------------------ | :------: | :---: | :----: | -------- |
| **2.0.x**        | **[1.21.1][1.21.1]**, **[1.21.3][1.21.3]**, **[1.21.4][1.21.4]**, **[1.21.5][1.21.5]**, **[1.21.6][1.21.6]**, **[1.21.7][1.21.7]** |    ✅    |  ✅   |   ✅   | Extended range + Beacon perimeter overlay |
| **1.x**          | Listed below       |    ✅    |  ✅   |   ✅   | Extended range only |

> If you play on Minecraft versions newer than **1.21.7**, use the latest **1.x** file until version **2.0.x** is ported.
